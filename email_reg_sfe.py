...
def envio_agente_reg(arg):
    ...
    pdf.cell(0, 10, global_data['nombre_formulario'], align='c',ln=1)
    ...
    width = pdf.get_string_width(global_data['expediente']) + 6
    ...
    #pdf.cell(35,12, global_data['expediente'], border=1, align="C", fill=False)
    #pdf.multi_cell(150,6, global_data['espe'], border=1, align="L", fill=False)
    ...
    pdf.cell(w=155, h=8, txt=global_data['espe'], border=1, align='l' )	
