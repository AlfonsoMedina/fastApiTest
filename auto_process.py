...
def insertRen(form_Id):
	...
	if flow_request == 0:
		...
		try:
			...
			print(e)
			error_process(form_Id,'Tiempo agotado 3, carga datos de ipas para renovacion, ID','true')
	else:
		pass
...
def ifExistId(findId):
	try:
		...
		archivo = open(f"logs/app_mea_{date_not_hour()}.log", "r")
		...
		ocurrencias = contenido.count(palabra_buscar)
